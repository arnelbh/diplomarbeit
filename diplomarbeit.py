...
class mylora(LoRa):
    ...
    def on_rx_done(self):
        ...
        data_str = [result['act1'], result['act2'], result['act3'], result['act4'], result['behelterMax'], result['behelterMin'], result['tempMax'], result['tempMin']]
        #print ("Send: ", data_str)
        ...
        message.append(len(data_str))

        for i in range(len(data_str)): message.append(data_str[i])
